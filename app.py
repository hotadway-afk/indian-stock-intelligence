...
try:
    ...
    if sec is None:
        ...
        st.info("V3.0 checks the exchange universe first and then attempts direct BSE identity resolution. If this still fails, the exchange provider did not return a usable identity for the input.")
        if not matches.empty:
    ...
    with tabs[3]:
        ...
        st.markdown("### What V3.0 should ingest")
